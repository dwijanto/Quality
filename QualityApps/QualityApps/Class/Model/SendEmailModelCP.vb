Imports Npgsql
Imports System.Text
Public Class SendEmailModelCP
    Dim myAdapter As PostgreSQLDBAdapter = PostgreSQLDBAdapter.getInstance
    Dim myParam As ParamAdapter = ParamAdapter.getInstance
    Dim Startday As Integer = myParam.GetStartDateCP
    Dim Endday As Integer = myParam.GetEndDateCP
    Public LastSendDate As Date = myParam.GetLastSendDateCP
