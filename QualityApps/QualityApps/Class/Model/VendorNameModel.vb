...
Public Class VendorNameModel
    ...
    Public ReadOnly Property tablename As String Implements IModel.tablename
        Get
            Return "quality.vendornameconversion"
        End Get
    End Property
    ...
    Public ReadOnly Property FilterField
        Get
            Return "vendornameoriginal like '%{0}%' or vendornameconversion like '%{0}%' "
        End Get
    End Property
    ...
    Public Function save(obj As Object, mye As ContentBaseEventArgs) As Boolean Implements IModel.save
        ...
        Using conn As Object = myadapter.getConnection
            ...
            sqlstr = "quality.sp_deletevendornameconversion"
            ...
            sqlstr = "quality.sp_insertvendornameconversion"
            dataadapter.InsertCommand = New NpgsqlCommand(sqlstr, conn)
            dataadapter.InsertCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "vendornameoriginal").SourceVersion = DataRowVersion.Current
            dataadapter.InsertCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "vendornameconversion").SourceVersion = DataRowVersion.Current
            ...
            sqlstr = "quality.sp_updatevendornameconversion"
            ...
            dataadapter.UpdateCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "vendornameoriginal").SourceVersion = DataRowVersion.Current
            dataadapter.UpdateCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "vendornameconversion").SourceVersion = DataRowVersion.Current
