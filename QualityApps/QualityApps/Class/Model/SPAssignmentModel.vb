Imports Npgsql
Imports System.Text
Public Class SPAssignmentModel
    Implements IModel
    ...
    Public ReadOnly Property FilterField
        Get
            Return "vendorcode like '%{0}%' or vendorname like '%{0}%' or shortname like '%{0}%' or spcode like '%{0}%' or bck1 like '%{0}%' or bck2 like '%{0}%' or bu like '%{0}%' "
        End Get
    End Property
    ...
    Public Function LoadData(DS As DataSet) As Boolean Implements IModel.LoadData
        ...
        Using conn As NpgsqlConnection = myadapter.getConnection
            ...
            sb.Append(String.Format("select u.id,u.vendorcode::text,v.vendorname::text,v.shortname::text,u.spcode,u.bck1,u.bck2,u.bu,v.vendorcode::text || ' - ' || coalesce(v.shortname::text,'') || ' - ' || v.vendorname as description from {0} u left join vendor v on v.vendorcode = u.vendorcode left join quality.sbu s on s.sbu = u.bu order by u.{1};", tablename, sortField))
    ...
    Public Function save(obj As Object, mye As ContentBaseEventArgs) As Boolean Implements IModel.save
        ...
        Using conn As Object = myadapter.getConnection
            ...
            sqlstr = "quality.sp_deletevendorsp"
            ...
            sqlstr = "quality.sp_insertvendorsp"
            ...
            dataadapter.InsertCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "spcode").SourceVersion = DataRowVersion.Current
            dataadapter.InsertCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "bck1").SourceVersion = DataRowVersion.Current
            dataadapter.InsertCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "bck2").SourceVersion = DataRowVersion.Current
            dataadapter.InsertCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "bu").SourceVersion = DataRowVersion.Current
            ...
            sqlstr = "quality.sp_updatevendorsp"
            ...
            dataadapter.UpdateCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "spcode").SourceVersion = DataRowVersion.Current
            dataadapter.UpdateCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "bck1").SourceVersion = DataRowVersion.Current
            dataadapter.UpdateCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "bck2").SourceVersion = DataRowVersion.Current
            dataadapter.UpdateCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "bu").SourceVersion = DataRowVersion.Current
