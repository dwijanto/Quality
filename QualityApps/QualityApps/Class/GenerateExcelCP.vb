...
Public Class GenerateExcelCP
    ...
    Public Function Run() As Boolean
        ...
        DS = New DataSet
        'Dim sqlstr = "select distinct vendor from quality.dailycptx where code isnull and vendor < 20000000 order by vendor;" 'Later you can join in master vendor to get the valid Vendor
        Dim sqlstr = "select distinct vendor,code from quality.dailycptx tx" &
