...
Public Class FormImportCookwareSH
    Public Shared myForm As FormImportCookwareSH
    Public YearWeek As Integer
    Private LatestPeriod As Integer

    Public Shared Function getInstance()
        If myForm Is Nothing Then
            myForm = New FormImportCookwareSH
    ...
    Private MyImport As New ImportShanghai(Me)
    ...
    Sub DoImport()
        ...
        Try
            Dim myImport = New ImportShanghai(Me)
