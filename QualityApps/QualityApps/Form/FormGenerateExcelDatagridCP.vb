...
Public Class FormGenerateExcelDatagridCP
    Public Shared myForm As FormGenerateExcelDatagridCP
    Dim myThread As New System.Threading.Thread(AddressOf DoWork)
    Dim myController As New GenerateExcelCPController
    ...
    Public Shared Function getInstance()
        If myForm Is Nothing Then
            myForm = New FormGenerateExcelDatagridCP
    ...
    Private Sub DoCreateExcel()
        ...
        Dim myGenerateExcel As New GenerateExcelCP(Me, MyDate)
    ...
    Private Sub DoCreateEmailEWS()
        'Dim myGenerateEmail As New GenerateEmail(Me, MyCallBack)
        Dim myGenerateEmail As New GenerateEmailCP(Me, MyCallBack, MyDate, Mydate2)
        myGenerateEmail.runEWS(myController.DS)
    End Sub
End Class