...
Public Class FormImportCookwareCzech
    Public Shared myForm As FormImportCookwareCzech
    Public YearWeek As Integer
    Private LatestPeriod As Integer
    Public Shared Function getInstance()
        If myForm Is Nothing Then
            myForm = New FormImportCookwareCzech
    ...
    Private MyImport As New ImportCzech(Me)
    ...
    Sub DoImport()
        ...
        Try
            Dim myImport = New ImportCzech(Me)
