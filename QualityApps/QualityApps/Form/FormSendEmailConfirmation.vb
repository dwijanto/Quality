...
Public Class FormSendEmailConfirmation
    Public Shared myform As FormSendEmailConfirmation

    Dim myThread As New System.Threading.Thread(AddressOf DoWork)
    Public myController As New SendEmailController
    ...
    Public Shared Function getInstance()
        If myform Is Nothing Then
            myform = New FormSendEmailConfirmation
    ...
    Private Sub DoCreateEmailEWS()
        ...
        Dim myGenerateEmail As New SendEmailConfirmation(Me, MyCallBack)
