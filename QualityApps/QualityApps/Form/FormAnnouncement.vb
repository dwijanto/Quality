...
Public Class FormAnnouncement
    Private Shared myform As FormAnnouncement

    Public Shared Function getInstance()
        If myform Is Nothing Then
            myform = New FormAnnouncement
    ...
    Dim myController As AnnouncementController
    ...
    Sub DoWork()
        myController = New AnnouncementController
        Try
        ...
        If Not myThread.IsAlive And Not IsNothing(myController) Then
            Select Case tx
                Case txEnum.NewRecord
                    drv = myController.GetNewRecord
                    drv.Row.Item("startdate") = Date.Today
                    drv.Row.Item("enddate") = Date.Today
                    Me.drv.BeginEdit()
            ...
            Dim myform = New DialogAnnouncement(drv)
