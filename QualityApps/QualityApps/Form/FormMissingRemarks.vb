...
Public Class FormMissingRemarks
    Private Shared myform As FormMissingRemarks
    Private MissingData As MissingDataEnum
    Public Shared Function getInstance()
        If myform Is Nothing Then
            myform = New FormMissingRemarks
    ...
    Dim myController As InspectionController
    ...
    Sub DoWork()
        myController = New InspectionController
        Try
