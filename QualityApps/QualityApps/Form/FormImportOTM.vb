...
Public Class FormImportOTM
    Public Shared myForm As FormImportOTM
    Public Shared Function getInstance()
        If myForm Is Nothing Then
            myForm = New FormImportOTM
    ...
    Private MyImport As New ImportOTM(Me)
