...
Public Class FormFirstCMMF
    Private Shared myform As FormFirstCMMF
    Dim myController As FirstCMMFController

    Public Shared Function getInstance()
        If myform Is Nothing Then
            myform = New FormFirstCMMF
    ...
    Sub DoWork()
        myController = New FirstCMMFController
        Try
