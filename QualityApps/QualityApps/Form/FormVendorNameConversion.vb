...
Public Class FormVendorNameConversion
    Private Shared myform As FormVendorNameConversion
    Dim myController As VendorNameController

    Public Shared Function getInstance()
        If myform Is Nothing Then
            myform = New FormVendorNameConversion
    ...
    Sub DoWork()
        myController = New VendorNameController
        Try
