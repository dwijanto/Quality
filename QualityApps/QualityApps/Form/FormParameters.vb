        ...
        Else
            Select Case id
                ...
                Case 4
                    ...
                    ParentId = myController.GetParentid("MailFolder")
                    ...
                    ParentId = myController.GetParentid("SBU Exception")
                    UcdgvParam2.BindingControl(Me, myController.BS2, ParentId, "SBU Exception")

                    ParentId = myController.GetParentid("Vendor Exception")
                    ...
                    ParentId = myController.GetParentid("Internal Email (to)")
                    ...
                    ParentId = myController.GetParentid("Internal Email (cc)")
