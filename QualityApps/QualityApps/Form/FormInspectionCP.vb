...
Public Class FormInspectionCP
    ...
    Dim myController As New InspectionControllerCP
    Private Shared myform As FormInspectionCP
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        If e.RowIndex >= 0 Then
            If e.ColumnIndex = 26 Then
                ...
                Dim myDialog As DialogHistoryCP = DialogHistoryCP.getInstance
    ...
    Private Sub ToolStripButton3_Click(sender As Object, e As EventArgs) Handles ToolStripButton3.Click
        SaveFileDialog1.FileName = String.Format("InspectionReportCP-{0:yyyyMMdd}.xlsx", Date.Today)
    ...
    Sub sendEmailWork()
        ...
        Try
            Dim GoSend As New SendEmailConfirmationCP(Me, MyCallBack)
    ...
    Private Sub ToolStripButton6_Click(sender As Object, e As EventArgs) Handles ToolStripButton6.Click
        Dim myform = New FormMissingRemarksCP(MissingDataEnum.MissingRemark)
        myform.Show()
    End Sub
    Private Sub ToolStripButton7_Click(sender As Object, e As EventArgs) Handles ToolStripButton7.Click
        Dim myform = New FormMissingRemarksCP(MissingDataEnum.MissingInspDate)
        myform.Show()
    End Sub
