Public Class FormTimeStampSendingReportCP

    Public Shared myForm As FormTimeStampSendingReportCP
    ...
    Public Shared Function getInstance()
        If myForm Is Nothing Then
            myForm = New FormTimeStampSendingReportCP
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        SaveFileDialog1.FileName = String.Format("TimeStampSendingReportCP-{0:yyyyMMdd}.xlsx", Date.Today)
        ...
        Dim sqlstr As String = String.Format("select * from quality.sendemailcptx {0}", criteria)
