...
Public Class FormImportDailyExtraction
    Public Shared myForm As FormImportDailyExtraction
    Public Shared Function getInstance()
        If myForm Is Nothing Then
            myForm = New FormImportDailyExtraction
    ...
    Private MyImport As New ImportDailyTx(Me)
    ...
    Sub DoImport()
        ...
        Try
            Dim myImport = New ImportDailyTx(Me)
